...
def q1():
    ...
    diff = (round(q1_norm - q1_binom, 3), round(q2_norm - q2_binom, 3), round(q3_norm - q3_binom, 3))
...
def q2():
    ...
    prob = (norm_ecdf(norm.mean() + norm.std()) - norm_ecdf(norm.mean() - norm.std()))

    prob_float = float(round(prob, 3))
    return prob_float
...
def q4():
    ...
    df_filtro = stars[stars["target"] == 0]["mean_profile"]
    false_pulsar_mean_profile_standardized = (df_filtro - df_filtro.mean()) / df_filtro.std()
    ...
    return round(norm_ecdf(quantil_80), 3), round(norm_ecdf(quantil_90), 3), round(norm_ecdf(quantil_95), 3)
...
def q5():
    ...
    diff = round(quantil_1 - norm_1, 3), round(quantil_2 - norm_2, 3), round(quantil_3 - norm_3, 3)
